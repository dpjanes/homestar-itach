...
exports.Model = iotdb.make_model('IRAppleTV')
    ...
    .action("iot-attribute:cursor.down")
    .action("iot-attribute:cursor.left")
    .action("iot-attribute:cursor.right")
    .action("iot-attribute:cursor.up")
    .action("iot-attribute:cursor.enter")
    .action("iot-attribute:cursor.leave")
    .action("iot-attribute:shuttle.play")
    .action("iot-attribute:shuttle.pause")
    .make();
